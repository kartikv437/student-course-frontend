import { IonPage, IonContent, IonToolbar, IonButtons, IonBackButton, IonGrid, IonRow, IonCol, IonCard, IonCardContent, IonList } from "@ionic/react"
            ...
            <IonContent fullscreen className="ion-padding">
                ...
                <IonGrid>
                    <IonRow className="program-list">
                        ...
                        {/* <IonCol size="12" *ngFor="let program of programs">
                        <IonCard className="program-card">
                            <img [src]="program.image" alt="{{ program.title }}">
                            <IonCardContent>
                                <h2 className="program-title">{{ program.title }}</h2>
